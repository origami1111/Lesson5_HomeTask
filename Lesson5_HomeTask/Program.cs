namespace Lesson5_HomeTask
{
    class Program
    {
        ...
        /// File should contain ONLY integers.As input values you have 2 numbers separated by space(' ') 
        /// for .txt and by comma(',') for .csv formats.​
        /// Input file can have 1 or several lines with data.​
        /// 
        /// Our code should get input data from file and do next operations:​
        ...
        /// 
        /// extension of output file should be an opposite from the input, like, if you read from.txt file, 
        /// the result should be saved into .csv and vice versa.​
        /// 
